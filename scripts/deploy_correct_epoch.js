/**
 * Deploy contract with correct epoch settings
 * This script uses epoch 2.0 based on testnet diagnosis
 */
...
async function deployContract() {
  ...
  const contractName = 'hello-world-correct-epoch'; // Using the correct epoch contract
  const contractPath = './contracts/hello-world-correct-epoch.clar';
  const fee = 200000; // 0.2 STX
  const nonce = 7; // Updated based on latest account check
  
  // Print deployment info
  console.log('======== EPOCH-CORRECTED DEPLOYMENT ========');
