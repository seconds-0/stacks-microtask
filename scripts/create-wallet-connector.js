// Script to create the wallet connector files
const fs = require('fs');
...
// Create a script that will use the official Leather Connect library
const walletConnectorCode = `// Stacks Wallet Connect - Using official Leather/Stacks connect library
(function() {
